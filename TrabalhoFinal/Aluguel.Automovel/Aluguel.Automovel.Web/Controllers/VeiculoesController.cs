...
namespace Aluguel.Automovel.Web.Controllers
{
    public class VeiculoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Modelo,Marca,Valor,TipoCarro")] Veiculo veiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Modelo,Marca,Valor,TipoCarro")] Veiculo veiculo)
        {
            if (ModelState.IsValid)
            {
